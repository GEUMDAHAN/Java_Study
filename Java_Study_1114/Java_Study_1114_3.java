...
public class Java_Study_1114_3 {

	public static void main(String[] args) {
		
		// Scanner를 이용한 키 입력
		Scanner scan = new Scanner(System.in); // 데이터를 입력받을 때 사용
		// Ctrl + Shift + o → 위에 import 뜸
		
		// 문제 1. 두 개의 정수를 입력받아, 그 합을 출력해보세요.
		...
		int div = x / y; // 입력받은 x와 y 나눈 값을 div에 대입
		System.out.println("두 정수를 나눈 값은 : " + div);
		
		// 문제 2. 실수형 변수 height을 선언하고 180.7을 할당(대입)하는 코드를 작성하기
		double height = 180.7;
		...
		int avg = (a + b) / 2; // a와 b를 더한 값에 2를 나눈 값을 avg에 대입
		...
		System.out.println("안녕하세요, "+name+"님! 당신은 "+age+"세입니다.");
